export function TestimonialSection() {
  return (
    <section className="l-testimonial-section" aria-label="Testimonial">
      <div className="l-testimonial-wrap">
        ...
        <div className="l-testimonial-credit">
          ...
          <div>
            <div className="l-testimonial-name">Pilot School Owner</div>
            <div className="l-testimonial-title">Cape Town, Western Cape</div>
          </div>
        </div>
      </div>
    </section>
